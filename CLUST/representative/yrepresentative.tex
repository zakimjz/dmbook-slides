...
\begin{frame}{Expectation-Maximization Clustering: Maximum Likelihood Estimation}
...
Each
cluster we have to reestiamte the $d\times d$ covariance matrix:
\begin{align*}
\cov_i = \matr{
...
\begin{frame}{Iris Principal Components Data: Full Covariance Matrix}
\setcounter{subfigure}{0}
\begin{figure}
\psset{unit=0.5in}
...
\begin{frame}{Iris Principal Components Data: Diagonal Covariance Matrix}
\begin{figure}
\psset{unit=0.5in}
\psset{dotscale=1.5,fillcolor=lightgray,
        arrowscale=2,PointName=none}
