...
# convert discrete weka db into our labels
sed -f conv_db.sed iris-discretizedMDL-conv.arff > iris-conv.txt
grep cl2 iris-conv.txt | grep pl2 | grep pw2 | wc
#sort rules by supp
sort -k 3,3 iris.disc.weka.rules.fmt
#find class rules
